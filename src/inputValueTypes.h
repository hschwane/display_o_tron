...
constexpr char* const InputValueType_names[numInputValueTypes] = {"cog", "sog", "bat1", "bat2", "bat3", "bat4", "bat5", "bat6", "bat7"};
 ...
 */
constexpr char* to_string(InputValueType val) {return InputValueType_names[static_cast<int>(val)];}
 ...
 */
InputValueType from_string(std::string_view s)
{
    int i=0;
